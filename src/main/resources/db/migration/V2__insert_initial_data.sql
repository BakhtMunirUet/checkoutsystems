...
(ITEM_ID, QUANTITY, OFFER_PRICE, START_DATE, END_DATE, IS_ACTIVE, CREATED_DATE)
SELECT ID, 2, 0.45, NOW(), NOW() + INTERVAL '7 days', TRUE, NOW()
FROM TBL_ITEM WHERE NAME = 'Apple';

-- seeding for second offer on banana in TBL_OFFER
INSERT INTO TBL_OFFER
(ITEM_ID, QUANTITY, OFFER_PRICE, START_DATE, END_DATE,  IS_ACTIVE, CREATED_DATE)
SELECT ID, 3, 0.50, NOW(), NOW() + INTERVAL '2 days', TRUE, NOW()
